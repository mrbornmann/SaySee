...
// Supabase client - loaded via CDN in production
// In artifact preview we use the in-memory fallback below
let supabase = null;
try {
  const { createClient } = await import("https://esm.sh/@supabase/supabase-js@2");
  supabase = createClient(SUPABASE_URL, SUPABASE_KEY);
} catch(e) { console.log("Supabase not available in preview - using local storage"); }
