...
function SaySeeLogo({height=36, white=false}){
  return(
    <img
      src={white ? "/src/App_SaySee_Logo_white.png" : "/src/App_SaySee_Logo.png"}
      alt="SaySee"
      height={height}
    ...
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#0F0C29,#302B63,#24243E)",display:"flex",alignItems:"flex-start",justifyContent:"center",padding:"20px 20px",overflowY:"auto"}}>
      <div style={{width:"min(94vw,440px)",paddingTop:"max(20px, 4vh)"}}>
        <div style={{textAlign:"center",marginBottom:28}}>
          <div style={{background:"#fff",borderRadius:16,padding:"12px 24px",display:"inline-block"}}>
            <SaySeeLogo height={44}/>
          </div>
        </div>
